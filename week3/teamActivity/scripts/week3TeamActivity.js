...
const fifteen100s = inventors.filter(
...
// TODO: Ask if means their total age, or how recent?
...
/*const category = document.querySelector('.mw-category');
const links = Array.from(category.querySelectorAll('a'));
let deBoulevards = links.filter(
    link => link.innerHTML.includes('de')
);
deBoulevards.forEach(
    boulevard => {
        console.log(boulevard.innerHTML);
    }
);*/
